...
mcmcSamples <- readRDS(mcmcSampleFiles[[grep("seedBagExperimentSamplesNonparametric.RDS", mcmcSampleFiles)]])
...
# - +Recover chains ----
all.chains = MCMCchains(mcmcSamples, params = c("mu0_s", "sigma0_s", "sigma_s"), 
                        mcmc.list = TRUE)
...
# - +Plot Rhat and HW ----
par(mfrow = c(1, 1))
jpeg(filename = paste0(outputDirectory, "rhat-hw-seedSurvival", ".jpeg"), 
     quality = 75)
...
par(mfrow = c(1, 1))
jpeg(filename = paste0(outputDirectory, "rhat-hw-germination", ".jpeg"), 
  quality = 75)
...
# - +Plot Rhat and HW ----
par(mfrow = c(1, 1))
jpeg(filename = paste0(outputDirectory, "rhat-hw-s0", ".jpeg"), quality = 75)
# plot distribution of Rhat values
