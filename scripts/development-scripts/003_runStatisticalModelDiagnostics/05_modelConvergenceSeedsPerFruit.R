...
mcmcSamples <- readRDS(mcmcSampleFiles[[grep("seedsPerFruitSamplesSimple.RDS", mcmcSampleFiles)]])
...
f(x = "nu_seeds", model = "seedsUndamagedSimple")
f(x = "sigma0_seeds", model = "seedsUndamagedSimple")
f(x = "sigma_seeds", model = "seedsUndamagedSimple")

# print trace plots for each parameter
f(x = "mu0", model = "propDamageSimple")
f(x = "sigma0", model = "propDamageSimple")
f(x = "sigma", model = "propDamageSimple")
...
jpeg(filename = paste0(outputDirectory, "rhat-heidelberg-seeds-undamaged-simple", ".jpeg"), 
  quality = 75)
...
jpeg(filename = paste0(outputDirectory, "rhat-heidelberg-prop-seeds-damaged-simple", ".jpeg"), 
     quality = 75)
# plot distribution of Rhat values
