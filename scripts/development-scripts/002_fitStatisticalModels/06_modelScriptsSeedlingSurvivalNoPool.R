...
saveRDS(data,file=paste0(modelDataDirectory,"seedlingSurvivalDataNoPool.RDS"))
...
saveRDS(samples.rjags,file=paste0(outMCMCDirectory,"seedlingSurvivalSamples-noPool.rds"))
