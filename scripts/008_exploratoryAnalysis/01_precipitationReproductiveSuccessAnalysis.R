...
rs2 <- readRDS("/Users/Gregor/Dropbox/clarkia-bet-hedging/outputs/005_calculatePopulationModelParameters/04_reproductiveSuccess/reproductiveSuccess-populationYear-mat.RDS")
...
for(i in 1:20){
 ...
 tmp<- apply(rs2[[i]],2,posterior.mode)
...
pdf(
  "~/Dropbox/clarkia-bet-hedging/products/figures/rs-climate-sensitivity.pdf",
  height = 8, width = 8)
