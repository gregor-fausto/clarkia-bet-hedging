...
pdf(file=paste0(outputDirectory,"population-viabilityTrials-germination.pdf"),height=6,width=6)
...
pdf(file=paste0(outputDirectory,"population-viabilityTrials-viability.pdf"),height=6,width=6)
...
pdf(file=paste0(outputDirectory,"ppc-viabilityTrial-germination.pdf"),height=6,width=6)
...
germ.min.sim=f2(y.sim=sims,y.obs=df,n.obs=df2,class=6,model.fun=min)
...
pdf(file=paste0(outputDirectory,"ppc-viabilityTrial-viability.pdf"),height=6,width=6)
