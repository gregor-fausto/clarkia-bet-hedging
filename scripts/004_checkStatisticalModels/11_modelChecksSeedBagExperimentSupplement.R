...
pdf(file=paste0(outputDirectory,"population-germination.pdf"),height=6,width=6)
...
pdf(file=paste0(outputDirectory,"population-seedSurvival.pdf"),height=8,width=6)
...
pdf(file=paste0(outputDirectory,"population-s0seedSurvival.pdf"),height=6,width=6)
...
pdf(file=paste0(outputDirectory,"ppc-germination.pdf"),height=6,width=6)
...
pdf(file=paste0(outputDirectory,"ppc-seedSurvival.pdf"),height=6,width=6)
...
pdf(file=paste0(outputDirectory,"ppc-s0SeedSurvival.pdf"),height=6,width=6)
