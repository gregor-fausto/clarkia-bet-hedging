...
dataList <- readRDS(paste0("/Users/Gregor/Dropbox/dataLibrary/chapter-3/","seedSamplesLikelihoodData.rds"))
...
for(i in 1:20){
  ...
  surv=model.tmp@coef[7:18]
  r1=cumprod(surv[1:6])
  r2=cumprod(surv[7:10])
  r3=cumprod(surv[11:12])
...
for(i in 1:20){
  ...
  persistence.3[i] = cumPersistence.1[10]
  
  # round 2
  survival.2=(surv[7:10])
