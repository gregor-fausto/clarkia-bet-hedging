...
mcmcSamples <- readRDS(mcmcSampleDirectory[[grep("seedsPerFruitPosteriorSamples-2.RDS",mcmcSampleDirectory)]])
...
seedsPerFruitData <- readRDS(tmpDataDirectory[[grep("seedsPerFruit.RDS",tmpDataDirectory)]])
