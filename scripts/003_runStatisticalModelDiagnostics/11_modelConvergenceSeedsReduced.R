...
mcmcSamples <- readRDS(mcmcSampleFiles[[grep("seedBagExperimentPosteriorSamples-reduced.RDS", mcmcSampleFiles)]])
...
# - +Plot Rhat and HW ----
par(mfrow = c(1, 1))
jpeg(filename = paste0(outputDirectory, "rhat-hw-seedSurvival-reduced", ".jpeg"), 
     quality = 75)
...
par(mfrow = c(1, 1))
jpeg(filename = paste0(outputDirectory, "rhat-hw-germination-reduced", ".jpeg"), 
  quality = 75)
...
# - +Plot Rhat and HW ----
par(mfrow = c(1, 1))
jpeg(filename = paste0(outputDirectory, "rhat-hw-s0-reduced", ".jpeg"), quality = 75)
# plot distribution of Rhat values
